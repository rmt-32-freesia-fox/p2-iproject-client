...
export default {
  data() {
    return {
      ...
      // url: `https://accounts.spotify.com/authorize?client_id=29694d93e1d24518aec34551ed349c5e&response_type=code&redirect_uri=https://redirectlagi-production.up.railway.app/redirect/&scope=user-top-read%20user-read-recently-played%20user-read-currently-playing%20user-read-private`
