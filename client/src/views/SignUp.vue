...
<template>
  <body style="background: url('../assets/img/carousel-1.jpg')">
    <div class="signup__container">
      <div class="container__child signup__thumbnail">
        ...
        <div class="thumbnail__content text-center" style="text-align: center">
          <h1 class="heading--primary" style="font-size: 50px">
            Welcome to Gymster
          </h1>
          <h2 class="heading--secondary">Are you ready to join the gymster?</h2>
        </div>
        <div class="thumbnail__links"></div>
      ...
      <div class="container__child signup__form">
        <form action="#">
          ...
          <div class="m-t-lg" style="margin-top: 2rem">
