            ...
            <div class="bg-gray-50 py-6">
                <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
                    <div class="flex flex-row flex-wrap">
                                ...
                                <div class="flex-shrink max-w-full w-full px-3 pb-5">
                                    <div class="px-8 py-6 border border-gray-100 bg-white">
                                        <form @submit.prevent="handleLogin({ email, password })"
                                            ...
                                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                                <label for="inpuemail4" class="inline-block mb-2">Password</label>
                        ...
                        <div class="flex-shrink max-w-full w-full lg:w-2/3 px-14  overflow-hidden">
                            <div class="w-full py-3">
                                <h2 class="text-gray-800 text-3xl font-bold">
                                    <span class="inline-block h-5 border-l-3 border-red-600 mr-2"></span>Register
                                </h2>
                            </div>
                            <div class="flex flex-row flex-wrap -mx-3">
                                <div class="flex-shrink max-w-full w-full px-3 pb-5">
                                    <div class="px-8 py-6 border border-gray-100 bg-white">
                                        <form @submit.prevent="handleRegister({ email, password })"
                                            class="flex flex-wrap flex-row -mx-4">
                                            <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                                <label for="inpuemail4" class="inline-block mb-2">Email</label>
                                                <input type="email" v-model="email"
                            ...
                            <div class="w-full bg-white">
                                <div class="mb-6">
                                    ...
                                    <ul class="post-number">
                                        ...
                                        <li class="border-b border-gray-100 hover:bg-gray-50">
                                            <a class="text-lg font-bold px-6 py-3 flex flex-row items-center"
                                                href="#">ZF plans $14 billion autonomous vehicle push, concept van</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
